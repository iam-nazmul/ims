...
try:
    from PySide6.QtCore import (Qt, QDate, QRegularExpression, QSortFilterProxyModel, QSize, Signal)
    ...
    from PyQt6.QtCore import (Qt, QDate, QRegularExpression, QSortFilterProxyModel, QSize)
